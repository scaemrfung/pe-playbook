/* Extra how-to, cues, PEW outcomes. House rules: soft tag, no elimination. */
window.GAME_EXTRAS = {
  "Angry Neighbour": {
    "numbers": "Large group · 1-5 · 5–8 min rounds.",
    "cues": [
      "Freeze on the whistle.",
      "Soft tag / foam throw — never the head."
    ],
    "more": [
      "Credit: PHYSEDGAMES. Original page: https://physedgames.com/angry-neighbour/."
    ],
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/angry-neighbour/"
    ],
  ...
  "Backyard Dog Tag": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/backyard-dog-tag/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Banana Tag": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/banana-tag/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Blob Tag": {
    ...
    "more": [
      ...
      "At four players, the blob must split into two pairs. This keeps the game safe and moving.",
      "If hands break, that blob freezes until they rejoin.",
      "Change the starter pair every 2 minutes."
    ],
    "variations": [
  ...
  "Bug Tag / Dead Ant": {
    ...
    "more": [
      ...
      "Four classmates each tap a different limb; all four say ‘alive’ and the ant is up.",
      "Taggers may not guard the ant. Change taggers every 90 seconds.",
      "PHYSEDGAMES large-group version: https://physedgames.com/dead-ant-tag/"
    ],
    "variations": [
  ...
  "Chicken Checkers": {
    ...
    "more": [
      ...
      "Reset after a line is made and play again."
    ],
    "variations": [
      "Must hop to a hoop.",
  ...
  "Clothespin Tag": {
    ...
    "more": [
      ...
      "A player with zero pins does 8 jumping jacks, gets one pin back from you, and re-enters."
    ],
    "variations": [
      "Team colours.",
  ...
  "Everybody’s It": {
    ...
    "more": [
      ...
      "PHYSEDGAMES large-group version: https://physedgames.com/everybodys-it/"
    ],
    "variations": [
      "Walk for 1–2.",
  ...
  "Freedom Catch": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/freedom-catch/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Frozen Tag": {
    ...
    "more": [
      ...
      "If almost everyone is frozen, blow a general unfreeze and restart with new taggers.",
      "Keep rounds under 2 minutes."
    ],
    "variations": [
  ...
  "Home Free Bad Guy Blob Tag": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/home-free-bad-guy-blob-tag/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Hospital Tag": {
    ...
    "more": [
      ...
      "A tag is a ‘wound.’ First wound: one hand covers the spot. Second: the other hand. Third: walk (do not run) to a hospital.",
      "At the hospital do a named 10-second stretch or 8 jumping jacks, then both hands are free.",
      "Rotate taggers every 90 seconds if you used a small tagger group."
    ],
    "variations": [
  ...
  "Hot Dog Tag": {
    ...
    "more": [
      ...
      "Change taggers every 2 minutes."
    ],
    "variations": [
  ...
  "Icebergs": {
    ...
    "more": [
      ...
      "If you ‘fall in,’ swim (jog) a lap of the gym and climb a hoop."
    ],
    "variations": [
  ...
  "Line Tag / Pac-Man": {
    ...
    "more": [
      ...
      "A tag on the shoulder. Our house rule: 5 jumping jacks on that spot, then re-enter as a runner (or become a second tagger if you want the blob to grow).",
      "Do not let sitters block a whole lane for the rest of the game — that is an elimination shape. If you use a ‘wall’ freeze, unfreeze after 10 seconds."
    ],
    "variations": [
  ...
  "Massive 10 Second Tag": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/massive-10-second-tag/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Mystery Number Tag": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/mystery-number-tag/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Octopus": {
    ...
    "cues": [
      "Seaweed plants both feet.",
      "Arms tag — the body stays on the spot."
    ],
    "more": [
      ...
      "Cross back each round. The path gets tighter.",
      "House rule: after two rounds as seaweed, do 8 jumping jacks and re-enter as a runner so the last three are not hunted forever.",
      "Last few runners become the next octopi."
    ],
    "variations": [
  ...
  "Reindeer Roundup": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/reindeer-roundup/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Sharks and Dolphins": {
    ...
    "more": [
      ...
      "A tagged dolphin becomes a shark for the next crossing (or becomes seaweed with planted feet and tagging arms — same family as Octopus).",
      "Our house rule: after two crossings as a shark, you may rescue back to dolphin with a stretch, so the last players are not hunted for minutes.",
      "Remove one hoop each round if you are using islands."
    ],
    "variations": [
  ...
  "Slap Rover": {
    ...
    "cues": [
      "Cross on ‘rover come over.’",
      "Soft tag. Re-enter next call."
    ],
    "more": [
      ...
      "No holding a chain across the gym that people have to break — that is a collision game. Taggers stay as individuals."
    ],
    "variations": [
      "Send a colour only.",
      "Must skip across."
  ...
  "Squirrel’s Tail": {
    ...
    "more": [
      ...
      "Trees (hoops) are 5-second safe zones."
    ],
    "variations": [
  ...
  "Survivor Tag": {
    ...
    "cues": [
      "A tag is a skill, then you are back in.",
    ...
    "more": [
      ...
      "New taggers every 60 seconds."
    ],
    "variations": [
      "Skill is a balance until a helper taps.",
      "Two skills on the second tag."
    ],
  ...
  "Tail Tag": {
    ...
    "cues": [
      "Two fingers on the pinnie, not on clothes.",
      "Hand the tail back."
    ],
    "more": [
      ...
      "No diving. No pulling shirts.",
      "Collect tails in a hoop if you want a ‘foxes and hens’ count at the whistle — then give them all back."
    ],
    "variations": [
  ...
  "Tripod Tag": {
    ...
    "cues": [
      "Safe shape is three points on the floor.",
      "3-second hold, then you must move."
    ],
    "more": [
    ...
    "variations": [
      ...
      "Must change the three points each time."
    ],
  ...
  "Tunnel Freeze": {
    ...
    "cues": [
      "Freeze wide.",
      "High-five unless both agree to a walk-through."
    ],
    "more": [
  ...
  "Waspital": {
    ...
    "more": [
      ...
      "Optional: buzzing sound is silly; the tag is still two-finger."
    ],
    "variations": [
  ...
  "Wolf’s Den": {
    ...
    "cues": [
      "Tag only in the den.",
      "Jacks, then one turn as a helper."
    ],
    "more": [
      "Cross on the call. Tagged help for one crossing. Reset wolves.",
      "PHYSEDGAMES large-group version: https://physedgames.com/wolfs-den/",
      "PHYSEDGAMES large-group setup lives on this card — no separate game.",
      "Credit: PHYSEDGAMES. Original page: https://physedgames.com/large-group-wolfs-den/."
    ],
    "variations": [
      "Walk for 1–2.",
      "Large-group setup from PHYSEDGAMES: This is the standard (width-of-the-gym) version for about 15–30 players. For 40–60 use Large Group Wolf’s Den instead.",
      "Large-group (PHYSEDGAMES): run the den the LENGTH of the gym so 40–60 can play. More wolves. Rabbits run end to end. Pinnies on new wolves."
    ],
  ...
  "3-Ball Soccer": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/3-ball-soccer/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "4-Goal Soccer": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/4-goal-soccer/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "5 Soccer Circle Ideas": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/5-soccer-circle-ideas/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Bench Ball": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/bench-ball/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Booger Ball": {
    ...
    "cues": [
      "The ball ‘sticks’ to the catcher — they must pass in 3 seconds.",
      "Uses the real sport ball."
    ],
    "more": [
      "Whoever catches is ‘it’ with the ball and cannot run. They pass to unstick.",
      "Score by a catch in a hoop or by tagging a cone.",
      "A drop is a turnover. Keep it silly, keep it safe."
    ],
    "variations": [
  ...
  "Captain Ball": {
    ...
    "cues": [
      "Captain stays in the hoop.",
      "Three completes to score."
    ],
    "more": [
      ...
      "Defence may intercept but not contact the captain."
    ],
    "variations": [
      "Two captains.",
      "Captain must volley or bounce-pass out."
    ],
  ...
  "Capture The Flag Outdoors": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/capture-the-flag-outdoors/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Collect the Treasure": {
    ...
    "variations": [
      "Must crab-walk.",
      "Steal from other nests after the middle is empty."
    ],
  ...
  "Crab Football": {
    ...
    "cues": [
      "Hips up. Short bouts for wrists.",
      "Uses the real sport ball."
    ],
    "more": [
  ...
  "Crazy Ball Soccer": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/crazy-ball-soccer/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "End Ball": {
    ...
    "cues": [
      "Pivot, don’t run.",
      "5-second hold. Pass to space."
    ],
    "more": [
      "End zones are 2–3 metres deep (mats or cones).",
      "Score with a catch in the far end zone. The carrier cannot run — pivot only.",
      "Incomplete or intercept: other team’s ball from that spot.",
      "After a score, restart at centre. Rotate the end-zone catcher if you use a designated captain."
    ],
    "variations": [
      "Must complete 3 passes before a score (The Perfect Pass).",
      "Walking only for Grade 1–2."
    ],
  ...
  "End Wall Soccer": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/end-wall-soccer/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "End Zone Ball": {
    ...
    "variations": [
      ...
      "Score only in a hoop inside the end zone."
    ],
  ...
  "Four Corner Flags": {
    ...
    "cues": [
      "Safe in your own quarter.",
      "One flag at a time. Walk a jail rescue."
    ],
    "more": [
      ...
      "Goal: bring all of your colour home, or collect one of every colour.",
      "Tagged in another quarter: sit or stand at that jail. A teammate tags you free; you both walk home. No stealing on a rescue walk.",
      "You may not throw a flag. One item at a time (flag or rescue, not both)."
    ],
    "variations": [
  ...
  "Fruit Salad": {
    ...
    "more": [
      ...
      "‘Fruit salad’ = everyone swaps.",
      "Leftovers never sit out a turn — they become middle.",
      "PHYSEDGAMES large-group version: https://physedgames.com/fruit-salad/"
    ],
    "variations": [
      "Add a locomotor (skip to your new spot).",
      "Use sport names.",
      "Large-group setup from PHYSEDGAMES: Give taggers different-coloured pinnies. As a class, name a fruit for each colour and a freeze shape for that fruit (apple = round; banana = curve)."
    ],
  ...
  "Guard the Gates": {
    ...
    "cues": [
      "Intercept, don’t contact.",
      "Attackers dribble through, not around the wall."
    ],
    "more": [
      ...
      "Rotate attack/defence every 2 minutes."
    ],
    "variations": [
      "Hands-only reverse version.",
      "Must pass before a gate."
    ],
  ...
  "Home Alone": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/home-alone/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Hurley Burley": {
    ...
    "cues": [
      "A tip means you must pass at once.",
      "Kick-in goal 3, hit 2, throw 1."
    ],
    "more": [
      ...
      "Turnovers on a drop or an out-of-bounds."
    ],
    "variations": [
      "Hands only.",
      "Feet only."
  ...
  "Numbers Hockey": {
    ...
    "more": [
      ...
      "If you have no sticks, play the same shape with feet and a sport ball."
    ],
    "variations": [
  ...
  "Pin Galore Soccer": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/pin-galore-soccer/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Reverse Soccer": {
    ...
    "cues": [
      "Hands tap or pass — no carry.",
      "Keepers use feet only."
    ],
    "more": [
  ...
  "Rob the Nest (dribble)": {
    ...
    "more": [
      ...
      "On the whistle, freeze. Count. Play another 60 seconds.",
      "A knocked ball is dead until you recover your dribble."
    ],
    "variations": [
      "Hands only (beanbags).",
  ...
  "Sideline Soccer": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/sideline-soccer/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Slappers!": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/slappers/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Stones": {
    ...
    "more": [
      ...
      "The class wins if the path reaches the other side before the whistle."
    ],
    "variations": [
      "Must hop the finished path.",
      "Colour stones to colour nests."
    ],
  ...
  "Team Tag": {
    ...
    "cues": [
      "Tag the other colour only.",
      "A tag switches your colour or sends you to a stretch."
    ],
    "more": [
  ...
  "The Perfect Pass": {
    ...
    "more": [
      ...
      "A drop or intercept resets that team’s count.",
      "After a score, the other team starts from their end."
    ],
    "variations": [
      "Everyone on the team must touch.",
      "Non-dominant-hand passes only for one round."
    ],
  ...
  "Traffic Lights (kick)": {
    ...
    "cues": [
      "Green dribble, yellow trap, red sole-stop.",
      "Eyes up."
    ],
    "more": [
  ...
  "Wall Soccer": {
    ...
    "more": [
      ...
      "Sport ball. Grade 1–2: big goal, no keepers, just cone goals."
    ],
    "variations": [
      "One-touch finish.",
      "Must shoot below hip height."
    ],
  ...
  "Battleships": {
    ...
    "cues": [
      "Stay in your zone.",
      "Reset a pin; do not throw it back."
    ],
    "more": [
  ...
  "Bucket Ball": {
    ...
    "more": [
      ...
      "Fetchers stand to the side, not in the lane."
    ],
    "variations": [
  ...
  "Card Sharks": {
    ...
    "more": [
      ...
      "Trade cards and play again. Leftover cards stay in a hoop."
    ],
    "variations": [
  ...
  "FLY BACK": {
    ...
    "cues": [
      "Throw, fly out, come back on a catch.",
      "Call it."
    ],
    "more": [
  ...
  "Frisbee Flingers": {
    ...
    "cues": [
      ...
      "A drop restarts that disc."
    ],
    "more": [
      "Complete a catch in a scoring hoop or end zone.",
      "The thrower cannot run. The receiver may move.",
      "Drop = restart that disc from the last complete spot or from a cone."
    ],
    "variations": [
  ...
  "Low-ball": {
    "numbers": "4–6 dodgeballs.",
    "cues": [
      "Feet and shins.",
      "Stretch, then back in."
    ],
    "more": [
  ...
  "Poison Ball": {
    ...
    "cues": [
      "Below the waist or a two-hand catch is safe.",
      "A hit walks you to the other team — you stay in the game."
    ],
    "more": [
  ...
  "Robin’s Nest": {
    ...
    "more": [
      ...
      "October version is often feet (dribble); November can be hands."
    ],
    "variations": [
      "Must trap before you pick up.",
  ...
  "Skittles": {
    ...
    "more": [
      ...
      "Fetchers are safe. Reset pins every round."
    ],
    "variations": [
  ...
  "Slide Sling Save": {
    ...
    "cues": [
      "Slide at feet.",
      "A hit walks to jail; a teammate catch frees you."
    ],
    "more": [
      ...
      "No throwing at knees from close range — slide from a line."
    ],
    "variations": [
      "Must bounce once.",
      "Two jails."
  ...
  "Survivor Dodgeball": {
    ...
    "cues": [
      "Same house rules as Poison Ball.",
      "Re-enter after a stretch."
    ],
    "more": [
  ...
  "Tidy the Bedroom": {
    ...
    "more": [
      ...
      "Switch roles. Count clothes in drawers on the whistle."
    ],
    "variations": [
  ...
  "Aces": {
    ...
    "cues": [
      "Serve underhand.",
      "A miss is a point to the other side, then rotate."
    ],
    "more": [
    ...
    "variations": [
      "Two-bounce allowed.",
      "Must pass to a teammate before it goes back."
    ],
  ...
  "Barkball": {
    ...
    "cues": [
      "Call before you catch.",
      "Below-shoulder sends."
    ],
    "more": [
      ...
      "Score by a catch in an end zone or hoop."
    ],
    "variations": [
      "Must use the other team’s names (harder listen).",
      "Quiet mouths for one round — hand signals only."
    ],
  ...
  "Beat Ball / Beat the Ball": {
    ...
    "more": [
      ...
      "Everyone kicks. Fielders rotate one spot after each kick."
    ],
    "variations": [
      "Two bases only.",
  ...
  "Bombardment": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/bombardment/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Castleball": {
    ...
    "more": [
      ...
      "Credit: PHYSEDGAMES. Original page: https://physedgames.com/castleball-2-0/."
    ],
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/castleball/",
  ...
  "Catch & Step": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/catch-step/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Chuck the Chicken": {
    ...
    "cues": [
      "Thrower stays, team sprints around them.",
      "Fielding team passes to freeze the count."
    ],
    "more": [
      ...
      "Then switch throwers. Everyone throws once if you can."
    ],
    "variations": [
      "Must use an underhand throw.",
      "Passes must be to a different person each time."
    ],
  ...
  "Continuous Kick Ball": {
    ...
    "cues": [
      "Everyone kicks.",
      "Throw to the base, not the runner."
    ],
    "more": [
      ...
      "Keep the kicking order moving. After 3 outs or after the whole order, teams switch — or use continuous: the kicker fields, a fielder comes in to kick.",
      "House rule: no throwing the ball at a runner."
    ],
    "variations": [
      "One-base and back (Quick Baseball).",
      "Tee instead of a roll."
    ],
  ...
  "Diamond Strike": {
    ...
    "cues": [
      "One hit, everyone moves one base.",
      "Field to the middle cone."
    ],
    "more": [
      ...
      "Rotate the four hitters after two hits."
    ],
    "variations": [
  ...
  "Hit and Run": {
    ...
    "cues": [
      "Contact, then look up.",
      "Field to a hoop."
    ],
    "more": [
      "Hit or kick, run a short marked path.",
      "Fielders throw to a hoop, never at the runner.",
      "Next hitter as soon as the ball is dead."
    ],
    "variations": [
      "Opposite-side hits.",
      "Must slide-stop at the hoop (no dive)."
    ],
  ...
  "Jailbreakers": {
    ...
    "cues": [
      "Rescue is a tag and a walk home.",
    ...
    "more": [
      ...
      "If the jail is empty, play on."
    ],
    "variations": [
      "Two-hand join on the walk.",
      "Jailbreak: one special player may free the whole jail once."
    ],
  ...
  "Longball": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/longball/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "RPS Rounders": {
    ...
    "more": [
      ...
      "No best-of-seven stalls — one throw and go."
    ],
    "variations": [
  ...
  "Shark Ball": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/shark-ball/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Strikeball": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/strikeball/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Thunderball": {
    ...
    "cues": [
      "Hit through the rows, not at people.",
      "Defence stops the ball before it crosses."
    ],
    "more": [
      "Three cone rows. Hit or kick. Past row 1 = 1 point, row 2 = 2, row 3 = 3.",
      "Defence in the lanes stops the ball before the next row.",
      "Everyone hits, then swap. Wiffle or t-ball only — no hard bats indoors."
    ],
    "variations": [
      "Kick only.",
  ...
  "Attention Relay": {
    ...
    "more": [
      ...
      "Keeps listening sharp on a fitness day."
    ],
    "variations": [
  ...
  "Cone Relay": {
    ...
    "more": [
      ...
      "Tidy stacks beat messy speed."
    ],
    "variations": [
      "Must sidestep.",
      "Upside-down stacks only."
    ],
  ...
  "Hungry Snake": {
    ...
    "cues": [
      "Hold waists or a hoop train — no yanking.",
      "The head tags."
    ],
    "more": [
      "A small chain is the snake. The head tags runners. A tagged runner joins the tail.",
      "Split at 6 into two snakes.",
      "If the chain breaks, that snake freezes until it joins again."
    ],
    "variations": [
      "Must stay on lines.",
      "Two snakes from the start."
    ],
  ...
  "Ice Cream Cone Relays": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/ice-cream-cone-relays/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Jungle Run Relays": {
    ...
    "more": [
      ...
      "A miss means redo that obstacle, not the whole race sit-out."
    ],
    "variations": [
      "Crab one segment.",
      "Carry a beanbag."
  ...
  "Memory Relay": {
    ...
    "more": [
      ...
      "The last runner performs the whole sequence. Then reveal."
    ],
    "variations": [
  ...
  "Pip, Squeak and Wilbur": {
    ...
    "cues": [
      ...
      "The three names chase in order."
    ],
    "more": [
      ...
      "Rotate the three runners often. Tagged runner takes the next name in the chain."
    ],
    "variations": [
  ...
  "Plant the Trees": {
    ...
    "more": [
      ...
      "Second round: ‘log’ the trees (knock them gently) and replant."
    ],
    "variations": [
  ...
  "Rescue Relay": {
    ...
    "cues": [
      "Go get one teammate and bring them home.",
      "Two-hand join or a hoop for two."
    ],
    "more": [
  ...
  "Back to Base": {
    ...
    "cues": [
      "Whistle means home.",
      "Last group leads a stretch — they are not out."
    ],
    "more": [
      "Each student or pair has a home hoop.",
      "On the whistle, everyone returns. Use after circus or station work.",
      "The last group leads 10 seconds of stretching, then everyone is ready."
    ],
    "variations": [
  ...
  "Buffalo": {
    ...
    "more": [
      ...
      "Split the herd at 6 so it stays safe."
    ],
    "variations": [
      "Two herds.",
      "Must stay on lines."
  ...
  "Captain’s Deck / Shipwreck": {
    ...
    "more": [
      ...
      "Call one command at a time. No elimination — late movers do 5 jumping jacks and stay in.",
      "A student captain after the first two minutes."
    ],
    "variations": [
  ...
  "Dash for Safety": {
    ...
    "cues": [
      "Leave the centre on the colour.",
      "Tagged players stretch and re-enter next call."
    ],
    "more": [
      ...
      "Change the caller after a minute."
    ],
    "variations": [
      "Two colours at once.",
      "Must dribble to safety."
    ],
  ...
  "Daytime / Nighttime": {
    "numbers": "Whole class · 4 min.",
    "cues": [
      "Day = move. Night = freeze.",
      "Eyes stay open at night."
    ],
    "more": [
      ...
      "Add a locomotor for daytime."
    ],
    "variations": [
      "Dawn = slow motion.",
      "Student owl watches instead of the teacher."
    ],
  ...
  "European Rhythmic Running": {
    ...
    "more": [
      ...
      "A student can be the drummer after you model."
    ],
    "variations": [
  ...
  "Follow the Leader": {
    ...
    "more": [
      ...
      "Keep lines short so the back can see."
    ],
    "variations": [
  ...
  "Group Numbers": {
    ...
    "cues": [
      "Jog until the number.",
      "Leftovers join the teacher — they are not out."
    ],
    "more": [
      "Jog in space. Call a number. Students make groups of that size in 5 seconds.",
      "Leftovers make a group with you. Then jog again.",
      "Finish on the class size so everyone is in one group.",
      "Also filed as The Number Game (merged).",
      "Credit: PHYSEDGAMES. Original page: https://physedgames.com/the-number-game/."
    ],
    "variations": [
      "Must hold a shape in the group.",
      "Call ‘plus one muscle’ and they add a stretch.",
      "Travel 20–30 seconds first (run, skip, hop), then freeze and form groups of the called number. Leftovers join the teacher — never out."
    ],
  ...
  "Here, There, Everywhere": {
    "numbers": "Whole class · 4 min.",
    "cues": [
      "Here = toward the teacher. There = away. Everywhere = scatter."
    ],
    "more": [
  ...
  "Human Bop-It": {
    "numbers": "Whole class · 4 min.",
    "cues": [
      "Hear the action, then do it.",
      "Freeze between calls."
    ],
    "more": [
      ...
      "A student caller for Grade 4+."
    ],
    "variations": [
      "Add ‘repeat’ to do the last action twice.",
      "Opposite actions (twist the other way)."
    ],
  ...
  "Laps and Lines / Signals": {
    ...
    "more": [
      ...
      "Use it to reset a messy gym in 20 seconds."
    ],
    "variations": [
  ...
  "Rikki Tikki": {
    ...
    "more": [
      ...
      "Consent: a student may show a nearby space instead of a touch."
    ],
    "variations": [
  ...
  "Rubber Band": {
    ...
    "cues": [
      "The band expands and shrinks on the call.",
      "Do not let go."
    ],
    "more": [
      ...
      "A student caller after one minute."
    ],
    "variations": [
  ...
  "Silly Bananas": {
    ...
    "more": [
      ...
      "Students may invent one silly fruit at the end."
    ],
    "variations": [
  ...
  "Video Game": {
    ...
    "cues": [
      ...
      "A, B, start, pause mean taught actions."
    ],
    "more": [
      ...
      "A student can hold the ‘controller’ after you model."
    ],
    "variations": [
      "Two-player: half the class is player 1.",
      "Add a boss (a tagger) on ‘level 2.’"
    ],
  ...
  "Volcanoes and Ice-Cream Cones": {
    ...
    "more": [
      ...
      "Whistle, hands up, count. Reset for the next round.",
      "A cone being touched is ‘in play’ — the other team waits a second."
    ],
    "variations": [
  ...
  "Balloon Keep-Up": {
    ...
    "more": [
      ...
      "Grade 3+: must alternate touches.",
      "Also filed as Balloon keep-up station (merged)."
    ],
    "variations": [
      "Sit and keep-up.",
      "Add a second ball.",
  ...
  "Circle Hoop Pass": {
    ...
    "more": [
      ...
      "PHYSEDGAMES large-group version: https://physedgames.com/hoop-pass/"
    ],
    "variations": [
      "Large hoop for 1–2.",
  ...
  "Cooperative Wall Ball": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/cooperative-wall-ball/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Elves, Giants, Wizards": {
    ...
    "cues": [
      "Show the shape together.",
      "The winning shape chases; tagged players switch teams."
    ],
    "more": [
      ...
      "The winning team tags as the other team runs home. Tagged players join the other team (or do 5 jumps and stay, if mixing teams is messy).",
      "Play several quick rounds."
    ],
    "variations": [
  ...
  "Helicopter / Snake rope": {
    ...
    "more": [
      ...
      "Grade 1–2 walk the snake. The rope never goes above the shin."
    ],
    "variations": [
      "Two snakes.",
  ...
  "Invent-a-game": {
    ...
    "cues": [
      "Start, score, safety — three sentences."
    ],
    "more": [
  ...
  "Object Toss mixer": {
    ...
    "cues": [
      "Match the send to the object.",
      "Call the name before you throw."
    ],
    "more": [
  ...
  "Parachute popcorn / dome / cat-and-mouse": {
    ...
    "cues": [
      "Hold the handle, not the cloth.",
      "Bend knees for a dome."
    ],
    "more": [
  ...
  "Pass It On": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/pass-it-on/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Sharks and Dolphins (chute)": {
    ...
    "more": [
      ...
      "Lift a mushroom to change sharks if someone is under too long."
    ],
    "variations": [
  ...
  "Slippery Snakes": {
    ...
    "cues": [
      "The snake stays on the floor.",
      "Jump or step — do not stomp the turner’s hands."
    ],
    "more": [
      ...
      "Rotate turners every 30 seconds."
    ],
    "variations": [
      "Two snakes to cross.",
      "Travel sideways."
  ...
  "The Great Outdoor Treasure Hunt": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/the-great-outdoor-treasure-hunt/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Animals": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/animals/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Body-part beanbags": {
    ...
    "more": [
      ...
      "Pair: trade bags on a call without using hands if you can."
    ],
    "variations": [
      "Two bags.",
  ...
  "Bridges & Rivers": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/bridges-rivers/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Fitness Musical Hoops": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/fitness-musical-hoops/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Frogs on the Lily Pads": {
    ...
    "cues": [
      "Bend–jump–stick.",
      "Miss = start that path again."
    ],
    "more": [
      "Hoop lily pads in 3–4 paths. Jump hoop to hoop and hold the land for a count of 3.",
      "If you miss the hoop, restart that path. No pushing the next frog.",
      "Change the path after 2 minutes (zig-zag, wider gaps)."
    ],
    "variations": [
      "Two-to-one landings.",
      "Carry a beanbag on the head."
  ...
  "Hula Hoop Twister": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/hula-hoop-twister/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Hulahoop Madness": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/hulahoop-madness/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Immersive Workout ADVENTURE All Ages Brain Break": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/immersive-workout-adventure-all-ages-brain-break/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Jump The River": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/jump-the-river/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Mass Challenges": {
    ...
    "cues": [
      "Whole class succeeds or you reset the challenge — no one is cut."
    ],
    "more": [
      ...
      "Celebrate the solve, not a winner."
    ],
    "variations": [
      "No talking.",
  ...
  "Minute Fitness": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/minute-fitness/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Mirror Mirror": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/mirror-mirror/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Oyster Shell": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/oyster-shell/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Pair Running": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/paarlauf/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Rainbow Road": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/843/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Red Line": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/red-line/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "RPS Warm-up": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/rps-warm-up/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Rush Hour": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/rush-hour/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Safe to Shore": {
    ...
    "more": [
      ...
      "Add a current: you may only travel forward, not back, on the second crossing."
    ],
    "variations": [
  ...
  "Sneak & React": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/sneak-react/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "The Video Camera Game": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/the-video-camera-game/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
  ...
  "Throw & Go": {
    ...
    "variations": [
      "Source: PHYSEDGAMES — https://physedgames.com/throw-go/"
    ],
    "look": "Everyone is moving or has a role. Nobody sits the period.",
    "outcomes": [
      {
