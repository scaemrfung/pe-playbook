window.K2_MONTH_GAMES = {
  September: [
    ...
    ["Land and Sea", "", "A line is the shore. Jump to land or sea on the call. Mix in hop, turn, or freeze."],
    ["Here, There, Everywhere", "", "Point: here = toward you, there = away, everywhere = scatter. Change locomotor each round."]
  ],
  October: [
  ...
  December: [
    ["Follow the Leader", "", "Lines of 4. Leader chooses a locomotor or shape. Switch leaders every 20 seconds on the drum."],
    ["Silly Bananas", "", "Move like the called fruit or animal. Freeze in a shape on ‘peel.’ Use as a rhythm warm-up."],
    ["Shadow Tag", "", "Tag by stepping on a shadow (or a poly-spot ‘shadow’ indoors). Soft feet. Switch taggers often."]
  ],
  January: [
  ...
  February: [
    ["Icebergs", "", "Hoops are icebergs. Move between them on the call. Remove one hoop each round. Share an iceberg; no sitting out."],
    ["Tail Tag", "", "Bibs as tails. Pull a tail with two fingers, hand it back, and that player is the new tagger. No clothing grabs."],
    ["Slippery Snakes", "", "Long ropes on the floor wiggle slowly. Jump or step over. G1–2 walk the snake."]
  ],
  March: [
    ["Balloon Keep-Up", "", "Beach ball or balloon. Class or small groups keep it up. Count a class record. Drops restart the count, not the player."],
    ["Back to Base", "", "On the whistle, everyone returns to a home hoop. Last group leads the next stretch. Use after a circus station."]
  ],
  April: [
    ["Frogs on the Lily Pads", "", "Hoop lily pads. Jump hoop to hoop and stick the landing. If you miss, start that path again."],
    ["Safe to Shore", "", "Cross the gym on mats/hoops without touching the floor. If the ‘water’ tags your foot, go back and try a new path."]
  ],
  May: [
    ["Jungle Run Relays", "", "Relay over cones, a hoop step-in, and a jump. Next runner goes on a hand-off, not a shout only."],
...
window.K2_DETAILS = [
{
  name: "Kangaroos and Crocodiles", source: "", months: ["September"],
...
{
  name: "Volcanoes and Ice-Cream Cones", source: "", months: ["September"],
...
{
  name: "Octopus", source: "", months: ["September"],
...
{
  name: "Group Numbers", source: "", months: ["September"],
...
{
  name: "Fruit Salad", source: "", months: ["September"],
...
{
  name: "Land and Sea", source: "", months: ["September"],
...
{
  name: "Here, There, Everywhere", source: "", months: ["September","December"],
...
{
  name: "Follow the Leader", source: "", months: ["December","April"],
...
{
  name: "Silly Bananas", source: "", months: ["December"],
...
{
  name: "Shadow Tag", source: "", months: ["December"],
...
{
  name: "Collect the Treasure", source: "", months: ["January"],
...
{
  name: "Waspital", source: "", months: ["January"],
...
{
  name: "Icebergs", source: "", months: ["February"],
...
{
  name: "Tail Tag", source: "", months: ["February"],
...
{
  name: "Slippery Snakes", source: "", months: ["February"],
...
{
  name: "Balloon Keep-Up", source: "", months: ["March"],
...
{
  name: "Back to Base", source: "", months: ["March"],
...
{
  name: "Frogs on the Lily Pads", source: "", months: ["April"],
...
{
  name: "Safe to Shore", source: "", months: ["April"],
...
{
  name: "Jungle Run Relays", source: "", months: ["May"],
...
{
  name: "Survivor Tag", source: "", months: ["May"],
