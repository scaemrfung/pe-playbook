/* PEW K–6 (LearnAlberta, current curriculum). One or two outcomes + a look-for. */
window.LESSON_OUTCOMES = {
  "September-1-1": {
    items: [
    { code: "Safety", look: "Freezes on the first whistle and stays inside the lines." },
    { code: "Movement · spatial awareness", look: "Moves without bumping; keeps a bubble of personal space." }
    ]
  },
  "September-1-2": {
    items: [
  ...
  "September-1-4": {
    items: [
    { code: "Movement · fair play and teamwork", look: "Helps a partner finish a shared task." },
    { code: "Movement · fair play and teamwork", look: "Accepts a tag or a miss without arguing." }
    ]
  },
  "September-2-1": {
    items: [
  ...
  "October-3-4": {
    ...
    { code: "Safety", look: "Foam stays low." }
    ]
  },
  "October-4-1": {
    items: [
  ...
  "February-1-1": {
    items: [
    { code: "Safety", look: "Enters a rope only after a ready check." },
    { code: "Movement · run, jump, throw", look: "Jumps or runs through without yanking the rope." }
    ]
  },
  "February-1-2": {
    items: [
  ...
  "February-1-3": {
    items: [
    { code: "Movement · run, jump, throw", look: "Jumps in, jumps, or runs through a long rope." },
    { code: "Movement · fair play and teamwork", look: "Turns for someone else." }
    ]
  },
  "February-1-4": {
    items: [
    { code: "Active Living", look: "Stays in the rope game (march if needed)." },
    { code: "Movement · run, jump, throw", look: "Takes a turn as jumper or turner." }
    ]
  },
  "February-2-1": {
    items: [
    { code: "Movement · send, receive, retain", look: "Controls a hoop in personal space." },
    { code: "Safety", look: "Does not chase a hoop into others." }
    ]
  },
  "February-2-2": {
    items: [
    { code: "Movement · locomotor", look: "Travels with a hoop (step, hop, or roll)." },
    { code: "Movement · send, receive, retain", look: "Keeps the hoop while changing locomotor." }
    ]
  },
  "February-2-3": {
    items: [
  ...
  "February-2-4": {
    items: [
    { code: "Movement · rhythm and sequence", look: "Makes a short hoop phrase and freezes." },
    { code: "Movement · send, receive, retain", look: "Spin, travel, still ending." }
    ]
  },
  "February-3-1": {
    items: [
  ...
  "February-3-2": {
    items: [
    { code: "Movement · run, jump, throw", look: "Combines rope and hoop in one path." },
    { code: "Safety", look: "Course is safe for the next person." }
    ]
  },
  "February-3-3": {
    items: [
    { code: "Movement · fair play and teamwork", look: "Turns or jumps with a partner." },
    { code: "Movement · run, jump, throw", look: "Adjusts speed so both succeed." }
    ]
  },
  "February-3-4": {
    items: [
  ...
  "February-4-3": {
    items: [
    { code: "Movement · fair play and teamwork", look: "Roles rotate so everyone stays active." },
    { code: "Movement · run, jump, throw", look: "Joins the big-group rope or hoop game." }
    ]
  },
  "February-4-4": {
    items: [
    { code: "Active Living", look: "Private skip or hoop check." },
    { code: "Active Living", look: "Compares only to their last check." }
    ]
  },
  "March-1-1": {
    items: [
  ...
  "April-1-1": {
    items: [
    { code: "Movement · shapes and balance", look: "Named shape held 3 seconds with tight muscles." },
    { code: "Movement · shapes and balance", look: "Tuck, stretch, or another copied shape is still." }
    ]
  },
  "April-1-2": {
    items: [
    { code: "Movement · shapes and balance", look: "Travel with a still start and still end." },
    { code: "Movement · locomotor", look: "Animal or gymnast travel stays in a lane." }
    ]
  },
  "April-1-3": {
    items: [
    { code: "Movement · shapes and balance", look: "Balance held 3 seconds." },
    { code: "Movement · shapes and balance", look: "Eyes on a wall spot; can leave the shape." }
    ]
  },
  "April-1-4": {
    items: [
    { code: "Movement · shapes and balance", look: "Jump and stick a quiet landing." },
    { code: "Safety", look: "Toes then heels; no crashing into the next jumper." }
    ]
  },
  "April-2-1": {
    items: [
    { code: "Movement · shapes and balance", look: "Log roll is long and tight." },
    { code: "Safety", look: "Head does not lead a collapse." }
    ]
  },
  "April-2-2": {
    items: [
    { code: "Movement · shapes and balance", look: "Rock stays on the shoulder-blades." },
    { code: "Safety", look: "No neck-loading; skip a roll that is not taught." }
    ]
  },
  "April-2-3": {
    items: [
    { code: "Movement · shapes and balance", look: "Links two skills (shape + travel or jump + shape)." },
    { code: "Movement · shapes and balance", look: "Still ending." }
    ]
  },
  "April-2-4": {
    items: [
  ...
  "April-3-2": {
    items: [
    { code: "Movement · shapes and balance", look: "Hoop or mat pathway with a jump or shape." },
    { code: "Movement · locomotor", look: "Pathway is planned, not a race." }
    ]
  },
  "April-3-3": {
    items: [
    { code: "Movement · fair play and teamwork", look: "Consent; a student may say no." },
    { code: "Movement · shapes and balance", look: "Pair shape can be left instantly." }
    ]
  },
  "April-3-4": {
    items: [
    { code: "Movement · shapes and balance", look: "Copies or builds a short group sequence." },
    { code: "Movement · fair play and teamwork", look: "Still ending together." }
    ]
  },
  "April-4-1": {
    items: [
    { code: "Movement · shapes and balance", look: "Short routine with a still ending." },
    { code: "Movement · rhythm and sequence", look: "Shows one level change if ready." }
    ]
  },
  "April-4-2": {
    items: [
    { code: "Movement · fair play and teamwork", look: "Names one controlled moment in a peer routine." },
    { code: "Movement · shapes and balance", look: "Watches for stillness, not tricks." }
    ]
  },
  "April-4-3": {
    items: [
    { code: "Movement · shapes and balance", look: "Repeats a favourite April skill with control." },
    { code: "Safety", look: "Buffet stations stay safe." }
    ]
  },
  "April-4-4": {
    items: [
    { code: "Active Living", look: "Private gymnastics look-for." },
    { code: "Movement · shapes and balance", look: "Control goal, not a trick goal." }
    ]
  },
  "May-1-1": {
    items: [
  ...
  "May-4-4": {
    items: [
    { code: "Active Living", look: "Private skip or timed run." },
    { code: "Active Living", look: "Reviews a personal meet goal." }
    ]
  },
  "June-1-1": {
    items: [
    { code: "Safety", look: "Lines up and waits for the event." },
    { code: "Movement · run, jump, throw", look: "Rehearses one meet event fairly." }
    ]
  },
  "June-1-2": {
    items: [
    { code: "Movement · fair play and teamwork", look: "Cheers more than one team." },
    { code: "Movement · run, jump, throw", look: "Fair hand-off or fair start." }
    ]
  },
  "June-1-3": {
    items: [
    { code: "Movement · run, jump, throw", look: "Jump or throw to a zone." },
    { code: "Safety", look: "Safe field-event rotation." }
    ]
  },
  "June-1-4": {
    items: [
    { code: "Movement · fair play and teamwork", look: "Finishes the event; celebrates effort." },
    { code: "Movement · run, jump, throw", look: "Meet or mini-meet behaviour." }
    ]
  },
  "June-2-1": {
    items: [
  ...
  "June-2-3": {
    items: [
    { code: "Movement · send, receive, retain", look: "Hit off a tee; bat in the hoop." },
    { code: "Safety", look: "Looks up after contact before running." }
    ]
  },
  "June-2-4": {
    items: [
  ...
  "June-3-3": {
    items: [
    { code: "Movement · fair play and teamwork", look: "Includes a classmate at a festival station." },
    { code: "Active Living", look: "Plays a favourite year game to the whistle." }
    ]
  },
  "June-3-4": {
    items: [
