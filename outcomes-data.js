window.UNIT_OUTCOMES = {
  ...
  February: {
    ...
    g12: [
      ...
      "Roll or spin a hoop with control.",
      "Keep rope and hoop safety (down before talk; never at people)."
    ],
    g34: [
      "Complete a short string of two-foot self-turned jumps.",
      "Enter, jump, and exit a long rope.",
      "Travel while rolling a hoop; toss a hoop to a cone.",
      "Connect rope or hoop work to heart-rate talk."
    ],
    g56: [
  ...
  April: {
    ...
    g12: [
      ...
      "Travel like an animal with a still start and still end.",
      "Jump and stick a landing on a mat.",
      "Rock or log-roll on a mat with the head not leading a collapse."
    ],
    g34: [
    ...
    g56: [
      "Perform a 20–30 second routine with a level change and a still ending.",
      "Use a simple 3-cue rubric (stillness, control, ending) when watching peers.",
      "Peer safety-coach a station.",
